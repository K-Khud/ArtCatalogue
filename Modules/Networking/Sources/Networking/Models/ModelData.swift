...
public struct ModelData: Codable, Hashable, Identifiable {
...
//    public var suggestAutocompleteAll: Set<DataSuggestAutocompleteAll>
...
//                apiModel: String, apiLink: String, isBoosted: Bool, altTitles: AnyCodable? = nil, thumbnail: Thumbnail, mainReferenceNumber: String, hasNotBeenViewedMuch: Bool, boostRank: AnyCodable? = nil, dateStart: Double, dateEnd: Double, dateQualifierTitle: String, dateQualifierId: Double, dimensions: String, mediumDisplay: String, inscriptions: AnyCodable? = nil, creditLine: String, publicationHistory: AnyCodable? = nil, exhibitionHistory: AnyCodable? = nil, provenanceText: AnyCodable? = nil, publishingVerificationLevel: String, internalDepartmentId: Double, fiscalYear: AnyCodable? = nil, fiscalYearDeaccession: AnyCodable? = nil, isPublicDomain: Bool, isZoomable: Bool, maxZoomWindowSize: Double, copyrightNotice: AnyCodable? = nil, hasMultimediaResources: Bool, hasEducationalResources: Bool, colorfulness: Double, color: AnyCodable? = nil, latitude: AnyCodable? = nil, longitude: AnyCodable? = nil, latlon: AnyCodable? = nil, isOnView: Bool, onLoanDisplay: AnyCodable? = nil, galleryTitle: String, galleryId: Double, artworkTypeTitle: String, artworkTypeId: Double, departmentTitle: String, departmentId: String, artistId: Double, artistTitle: String, altArtistIds: [AnyCodable], artistIds: [AnyCodable], artistTitles: [AnyCodable], categoryIds: [AnyCodable], categoryTitles: [AnyCodable], artworkCatalogueIds: [AnyCodable], termTitles: [AnyCodable], styleId: AnyCodable? = nil, styleTitle: AnyCodable? = nil, altStyleIds: [AnyCodable], styleIds: [AnyCodable], styleTitles: [AnyCodable], classificationId: String, classificationTitle: String, altClassificationIds: [AnyCodable], classificationIds: [AnyCodable], classificationTitles: [AnyCodable], subjectId: String, altSubjectIds: [AnyCodable], subjectIds: [AnyCodable], subjectTitles: [AnyCodable], materialId: String, altMaterialIds: [AnyCodable], materialIds: [AnyCodable], materialTitles: [AnyCodable], techniqueId: String, altTechniqueIds: [AnyCodable], techniqueIds: [AnyCodable], techniqueTitles: [AnyCodable], themeTitles: [AnyCodable], altImageIds: [AnyCodable], documentIds: [AnyCodable], soundIds: [AnyCodable], videoIds: [AnyCodable], textIds: [AnyCodable], sectionIds: [AnyCodable], sectionTitles: [AnyCodable], siteIds: [AnyCodable], suggestAutocompleteAll: Set<DataSuggestAutocompleteAll>, lastUpdatedSource: String, lastUpdated: String, timestamp: String) {
        self.id = id
